...
namespace Nop.Plugin.Payments.Fondy
{
    ...
    public class FondyPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private const string FONDY_URL = "https://payment.albpay.io/api/checkout/redirect/";
        private const string FONDY_RESULTS_URL = "https://payment.albpay.io/api/status/order_id";
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.Fondy.Fields.MerchantId.Hint", "Specify the Alliance bank Merchan ID of your store on the website documentation.albpay.io");
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.Fondy.Fields.RedirectionTip", "For payment you will be redirected to the Alliance bank checkout page.");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.Fondy.Fields.PaymentMethodDescription", "For payment you will be redirected to the Alliance bank checkout page.");
